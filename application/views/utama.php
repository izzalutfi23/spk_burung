	...
	<div class="tm-main-content" id="top">
			...
			<div class="row" style="width: 100%;">
				...
				<div class="col-lg-6">
					<a href="<?=base_url('home/hasil')?>" class="float-right"><button class="mt-2 btn btn-outline-success"
							type="button">Lihat Hasil</button><a href="<?=base_url('home/hasil')?>"></a>
				</div>
			</div>
		</nav>
		...
		<div class="tm-page-wrap mx-auto">
			...
			<div class="tm-container-outer" id="tm-section-2">
                ...
                ?>
				<section
					class="<?=($no%2!=0 ? 'tm-slideshow-section':'tm-slideshow-section clearfix tm-slideshow-section-reverse')?>">
					<div class="<?=($no%2!=0 ? 'tm-slideshow':'tm-slideshow tm-right tm-slideshow-highlight')?>">
						<img src="<?=base_url('assets/post/'.$data->foto)?>" width="100%" alt="Image">
					</div>
					<div
						class="<?=($no%2!=0 ? 'tm-slideshow-description tm-bg-primary':'tm-slideshow-description tm-slideshow-description-left tm-bg-highlight')?>">
						<h2 class=""><?=$data->title?></h2>
						<p><?=substr($data->deskripsi, 0, 300)?>...</p>
						</p>
						<a href="<?=base_url('home/detail/'.$data->id)?>"
							class="<?=($no%2!=0 ? 'text-uppercase tm-btn tm-btn-white tm-btn-white-primary':'text-uppercase tm-btn tm-btn-white tm-btn-white-highlight')?>">Deatail</a>
					</div>
				</section>
				<?php } ?>
