    ...
    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
            <div class="navbar-wrapper">
                <a class="navbar-brand" href="javascript:;">Edit Data Event</a>
            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?=base_url('admin/event_update')?>" method="POST">
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                            ...
                                            <select name="id_user" class="form-control">
                                                ...
                                                ?>
                                                <option <?=($event->id_user==$djuri->id_user?'selected':'')?> value="<?=$djuri->id_user?>"><?=$djuri->nama_user?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
