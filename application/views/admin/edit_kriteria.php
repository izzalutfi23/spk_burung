            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?=base_url('admin/update_kriteria')?>" method="POST">
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Nama Kriteria</label>
                                            <input type="hidden" name="id" value="<?=$kriteria->id_kriteria?>">
                                            <input type="text" value="<?=$kriteria->nama_kriteria?>" name="nama_kriteria" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?=$kriteria->bobot?>" name="bobot" class="form-control">
                                        </div>
                                    </div>
                                </div>
